...
// Module
exports.push([module.i, ".Gallery_Gallery__2Ol_r {\n  display: flex;\n  flex-flow: column nowrap;\n  justify-items: center;\n  margin-top: calc(75px + 4rem);\n}\n\n@media (min-width: 600px) {\n  .Gallery_Gallery__2Ol_r {\n    flex-flow: row wrap;\n  }\n}\n", "",{"version":3,"sources":["Gallery.module.css"],"names":[],"mappings":"AAAA;EACE,aAAa;EACb,wBAAwB;EACxB,qBAAqB;EACrB,6BAA6B;AAC/B;;AAEA;EACE;IACE,mBAAmB;EACrB;AACF","file":"Gallery.module.css","sourcesContent":[".Gallery {\n  display: flex;\n  flex-flow: column nowrap;\n  justify-items: center;\n  margin-top: calc(75px + 4rem);\n}\n\n@media (min-width: 600px) {\n  .Gallery {\n    flex-flow: row wrap;\n  }\n}\n"]}]);
// Exports
exports.locals = {
...
//# sourceMappingURL=[id].js.08f0be9283bc9150b974.hot-update.js.map