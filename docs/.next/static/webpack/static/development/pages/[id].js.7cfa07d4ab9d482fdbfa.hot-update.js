...
// Module
exports.push([module.i, ".Gallery_Gallery__2Ol_r {\n  display: flex;\n  flex-flow: column nowrap;\n  margin-top: 75px;\n}\n\n@media (min-width: 600px) {\n  .Gallery_Gallery__2Ol_r {\n    flex-flow: row wrap;\n  }\n}\n", "",{"version":3,"sources":["Gallery.module.css"],"names":[],"mappings":"AAAA;EACE,aAAa;EACb,wBAAwB;EACxB,gBAAgB;AAClB;;AAEA;EACE;IACE,mBAAmB;EACrB;AACF","file":"Gallery.module.css","sourcesContent":[".Gallery {\n  display: flex;\n  flex-flow: column nowrap;\n  margin-top: 75px;\n}\n\n@media (min-width: 600px) {\n  .Gallery {\n    flex-flow: row wrap;\n  }\n}\n"]}]);
// Exports
exports.locals = {
...
//# sourceMappingURL=[id].js.7cfa07d4ab9d482fdbfa.hot-update.js.map